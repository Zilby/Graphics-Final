...
* Name and partners name (At most 1 partner for this assignment): Alex Zilbersher, no partner
* How many hours did it take you to complete this assignment? ~ 3 hours
* Did you collaborate or share ideas with any other students/TAs/Professors? Nope, only communication was done by looking at piazza. 
* Did you use any external resources? Just what was given and piazza, and basic searches to find functions like std::stoi
...
```cpp
// Compile with: g++ string.cpp -o string
#include <iostream>
#include <string>
...
<img align="right" src="https://arduino-info.wikispaces.com/file/view/RGB-animation.gif/264579766/RGB-animation.gif" width="400px" alt="picture">
