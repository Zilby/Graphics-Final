...
void SDLGraphicsProgram::update(){
    ...
    myObject->getTransform().translate(-5.0f,0.0f,-8.0f);
    ...
    newObject->getTransform().loadIdentity();
    newObject->getTransform().translate(5.0f,0.0f,-8.0f);
    newObject->getTransform().rotate(rot * 3.0f,-1,-1.0f,-1);
    newObject->getTransform().scale(1.5f,2.5f,2.0f);
    newObject->update(screenWidth,screenHeight);
}
