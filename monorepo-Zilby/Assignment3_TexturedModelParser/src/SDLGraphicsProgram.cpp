...
SDLGraphicsProgram::SDLGraphicsProgram(int w, int h, std::string objPath):screenWidth(w),screenHeight(h){
	// Initialization flag
	bool success = true;
    ...
    for(int i= 0; i < OBJECTS; ++i){ 
        Object* temp = new Object(objPath);
        // temp->LoadTexture("./objects/windmill/windmill_diffuse.ppm");
