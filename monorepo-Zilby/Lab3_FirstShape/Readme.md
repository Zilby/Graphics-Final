...
<img align="right" src="http://www.mshah.io/comp/Spring18/graphics/Lab/2/lab.png" width="400px" alt="picture">
...
- How many hours did it take you to complete this lab? ~0.2f
- Did you collaborate with any other students/TAs/Professors? Partners Chris and David
- Did you use any external resources? (Cite them below)
- (Optional) What was your favorite part of the lab? The abstract art
- (Optional) How would you improve the lab? Maybe add a little more complexity to this one. 
...
In lab 2 we built the primary primitive for our software renderer--the triangle!Now we are going to recreate that scene with OpenGL. Today's lab also requires a little bit of patience, as we get acquainted with the support code.
...
For this lab, you only need run `python build.py` to compile the source code from a terminal. If **clang++** is not available, you may use g++ instead (likely folks on Windows will have to do this).
...
<img align="center" src="http://www.mshah.io/comp/Spring18/graphics/Lab/2/lab2.png" width="400px" alt="picture">
